...
- **Home video carousel (2026-08-14, DECISIONS same date):** four
  ...
  The rule stands for every other film. In-contract consumer added
  2026-08-25: the team film's sounded rendition on /about
  (`girl-team-film.mp4` — site-authored, music bed only, no speech;
  the operator's confirmation is the record, DECISIONS same date).
...
- Total JS ≤ 30 KB (target ~0); no client framework hydration. *(First
  ...
  same date, the Girl Team unit's team film, in-contract); the
