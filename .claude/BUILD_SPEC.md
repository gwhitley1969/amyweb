...
family. (Since the 2026-08-27 chip rounds no outline CTA renders on the
light canvas — the black brand chip, `.cta--chip`, took those
placements; the re-ink stands as defense-in-depth, tokens.css COMPANION
RE-INK.) The ramp may never exceed pink-500 (the deepest surface holding
...
settle, a scroll-scrubbed drift on full-bleed band photos (no consumer since
2026-09-25, when the home van band's photo became a film panel — DECISIONS same
date; the primitive stays), a staggered rise for
...
exit, the dealt doors, the arch reveals, the band parallax (retired 2026-09-25 with
the band photo), the cursor light — the
...
Popover-API menu carries Services / About Amy / Visit Amy / Mobile /
Training at EVERY width (the two "Amy" labels since 2026-09-19 and
2026-09-23, Mobile since 2026-09-02) —
...
1. Dosing in any form: doses, units, mg/mcg quantities, reconstitution,
   ...
   with units — is legible in the served source; same terms. And the
   /injector-training reel `training-reel` (DECISIONS 2026-08-25),
   ...
   Evolysse cartons' fill-volume line are legible in the served card
...
- **Home video carousel (2026-08-14, DECISIONS same date):** five
  ...
  — site-authored, music bed only, no speech; the operator's
