...
And the home hero ARRIVAL (2026-08-28, operator direction): the home
screen now opens out of the black — her headline, lead, buttons, and
trust chips rise in one after another while her photo warms from
dark and the neon glow comes on last, about two seconds start to
finish. No words, photos, or layout changed — the settled page is
exactly what she approved before; only the way it arrives is new
(operator override of the no-hero-entrance rule; reduced-motion
visitors see the settled page instantly; DECISIONS 2026-08-28).
