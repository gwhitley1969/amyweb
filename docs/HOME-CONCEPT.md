...
| `dcd223a` | 2026-09-17 | **feat(home): the hero film is remade as a living-portrait film** — PR #190 (`feat/hero-living-portrait`); the three reel passages retire, `hero-living-portrait-v3.mp4` loops natively; AI-assisted, disclosed (DECISIONS 2026-09-17) |
...
- **The film since 2026-09-17.** The reel described in the next item
  is history: the hero now plays `hero-living-portrait-v3.mp4`, one
