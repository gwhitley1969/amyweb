...
| **Mobile Aesthetics logo joins the header** (left of the NG wordmark); vector rebuild from the clean 300px render; Amy picks from a side-by-side | Planned | F-437304 asset set |
