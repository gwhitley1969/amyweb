...
- Films play from media.needlegirlie.com on production (206 Range
  ...
  and no `data-ranges`; the film object is `hero-living-portrait-v7.mp4`
  on the media origin (206 on a range request, `video/mp4`) — the film
  since 2026-09-17, this cut since 2026-09-26 (DECISIONS 2026-09-17,
  2026-09-25 and its 2026-09-26 addendum).
